...
class ProfileScreenCurrentUser extends StatefulWidget {
  final String? image;
  final String? username;
  final String? userId; // Add the userId parameter
  final String? email;

  ProfileScreenCurrentUser( {this.image, this.username, this.userId , this.email});

  @override
  _ProfileScreenCurrentUserState createState() => _ProfileScreenCurrentUserState();
}

class _ProfileScreenCurrentUserState extends State<ProfileScreenCurrentUser> {
